...
def dbp_analysis_module(df: pd.DataFrame):
    ...
    st.caption(
        ...
        "The Health Canada limit is an absolute-concentration reference and is not drawn on percentage-based plots."
    )
...
def robot_dose_response_module(
    ...
    st.caption(
        f"WRAP is using the source field **{dose_col}** exactly as reported. "
